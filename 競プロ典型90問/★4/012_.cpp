...
{
public:
  unordered_map<pair<int, int>, pair<int, int>, HashPair> parent;
  unordered_map<pair<int, int>, int, HashPair> set_size;
...
int main()
{
  ...
  unordered_map<pair<int, int>, bool, HashPair> is_painted;
